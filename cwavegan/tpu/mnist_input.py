...
flags.DEFINE_string('mnist_train_data_file', './data/train.tfrecords', 'Training .tfrecord data file')
flags.DEFINE_string('mnist_test_data_file', './data/test.tfrecords', 'Test .tfrecord data file')
